...
class NeuralNetwork(nn.Module):
    ...
    def create_network(self):
        ...
        #old: layers.append(None)
        layers.append(self.get_activation(self.activation)) # do activation
        ...
        # HINT: You will use self.list_hidden here.
        # old: layers.append(None)
        layers.append(nn.Linear(self.list_hidden[-1], self.num_classes)) # last layer
    ...
    def init_weights(self):
        ...
        for module in self.modules():
            ...
            if isinstance(module, nn.Linear):
                ...
                mean = 0
                std_dev = 0.1
                nn.init.normal_(module.weight, mean=mean, std=std_dev)
